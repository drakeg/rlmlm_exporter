...
var errorDescriptionString = map[string]string{
	...
	"exit status 250": "No TCP/IP port number in license file and RLMlm service does not exist. (pre-v6 only)",
	...
	"exit status 204": "RLMlm vendor daemon did not respond within timeout interval.",
	...
	"exit status 180": "Internal RLMlm error—please report to Macrovision.",
	...
	"exit status 173": "RLMlm version of client newer than server.",
	...
	"exit status 166": "Future license file format or misspelling in license file. " +
		"The file was issued for a later version of RLMlm than this program understands.",
